...
def align_skeleton(skeleton, code):
    ...
    def helper_align(skeleton_idx, code_idx):
        ...
        Returns (match, cost)
            ...
            http://shaopu.tech/2021/07/04/CS%E5%9F%BA%E7%A1%80%E8%AF%BE%E7%A8%8B1/
        """
        ...
        new_results1="+["+code_char+"]"+result1
        possibilities.append((new_results1, 1+cost1))
        # Delete

        result2,cost2=helper_align(skeleton_idx+1, code_idx)
        new_results2="-["+skel_char+"]"+result2
        possibilities.append((new_results2, 1+cost2))
